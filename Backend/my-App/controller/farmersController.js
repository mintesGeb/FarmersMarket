...
exports.addReview = (req, res) => {
    Farmers.addReview(req.params.id, req.body)
        .then(result => {
            res.json(result)
        })
}
...
exports.deleteReview = (req, res) => {
    Farmers.deleteReview(req.params.id, req.params.revId)
        .then(result => {
            res.json(result)
        })
}
...
exports.addProduct = (req, res) => {
    Farmers.addProduct(req.params.id, req.body)
        .then(result => {
            res.json(result)
        })
}
...
exports.deleteProduct = (req, res) => {
    Farmers.deleteProduct(req.params.id, req.params.prodId)
        .then(result => {
            res.json(result)
        })
}
